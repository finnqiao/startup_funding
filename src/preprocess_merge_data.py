...
def aggregate_dataframes(data_path_list):
    for data_path in data_path_list:
        if 'companies' in data_path:
            companies_df = gen_h.read_data(data_path)
        elif 'investors' in data_path:
            investors_df = gen_h.read_data(data_path)
        elif 'rounds' in data_path:
            rounds_df = gen_h.read_data(data_path)
        elif 'acquisitions' in data_path:
            acquisitions_df = gen_h.read_data(data_path)
        elif 'ipo' in data_path:
            ipo_df = gen_h.read_data(data_path)
